...
test_function = COCOTestFunction(id=coco_id, constr_number=constr_number, dim=dim, xopt=xopt, fopt=fopt, ystar=ystar) # optimization problem definition
...
if (dim == 2):
    ...
    figure.solution_point(x_init, opti_result["x"], ystar)